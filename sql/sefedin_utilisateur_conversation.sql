...
CREATE TABLE `utilisateur_conversation` (
  ...
  `conversationId` enum('binaire','groupe') DEFAULT NULL,
  `userId` int DEFAULT NULL,
  PRIMARY KEY (`utilisateurConversationId`),
  KEY `userId` (`userId`),
  KEY `conversationId` (`conversationId`),
  CONSTRAINT `utilisateur_conversation_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `utilisateur` (`userId`)
...
INSERT INTO `utilisateur_conversation` VALUES (5,'binaire',1);
