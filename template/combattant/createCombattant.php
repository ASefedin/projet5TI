        ...
        <div class="my-div">
            <section>
                <?php if(isset($_SESSION['user'])) : ?>
                    ...
                    <p>Prenom<input type="text" placeholder="Prenom" class="form-control" id="Prenom" name="prenom" value="<?php if(isset($combattant)) : ?><?= $combattant->combattantPrenom ?><?php endif ?>" required></p>
                    ...
                    <p>description<input type="text" placeholder="description" class="form-control" id="description" name="description" value="<?php if(isset($combattant)) : ?><?= $combattant->combattantDescription ?>" required<?php endif ?>" ></p>
                    <p>image<input type="text" placeholder="Lien-Image" class="form-control" id="img" name="illustration" value="<?php if(isset($combattant)) : ?><?= $combattant->combattantIllustration ?><?php endif ?>" required></p>
                    
                    <div class="my-div">
                    <p>categorie de poids:</p>
                        <select name="categorie[]" id="categorie"required multiple class="select2"> <!--en crochet pour dire que c"est un tab-->
                    ...
                    <div class="my-div">
                        <p>competence requise:</p>
                            <select name="competence[]" id="competence"required multiple class="select2">
